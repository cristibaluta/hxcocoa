...
extern class NSDraggingImageComponent extends NSObject {
@private
    NSString *_key;
    id	_contents;
    NSRect _frame;
...
*/
	public var  NSRect frame;

}

NS_CLASS_AVAILABLE(10_7, NA)
extern class NSDraggingItem extends NSObject {
@private
    id _item;
    NSRect _frame;
    NSArray *_components;
...
*/
	public var (retain, readonly) id item;
...
*/
	public var  NSRect draggingFrame;
...
*/
	public var NSArray*(^imageComponentsProvider)(void);
#endif
...
*/
	public var (copy, readonly) NSArray *imageComponents;
