...
extern class NSTableRowView extends NSView {
@private
    NSView **_columnViews;
 ...
 */
	public var  (default, null) extends NSBackgroundStyle interiorBackgroundStyle;
 ...
 */
	public var  (default, null) extends NSInteger numberOfColumns;
