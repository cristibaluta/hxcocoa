...
extern class NSRange {
	...
	@:c public static function NSEqualRanges (range1:NSRange1, range2:NSRange) :Bool;
	@:c public static function NSUnionRange (range1:NSRange1, range2:NSRange) :NSRange;
	@:c public static function NSIntersectionRange (range1:NSRange1, range2:NSRange) :NSRange;
