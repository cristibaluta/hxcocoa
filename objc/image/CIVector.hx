...
/* the CGPoint x and y values are stored in the first X and Y values of the CIVector. */
	@:require(ios5) public static function vectorWithCGPoint (p:CGPoint) :CIVector;

/* the CGRect x, y, width, height values are stored in the first X, Y, Z, W values of the CIVector. */
	@:require(ios5) public static function vectorWithCGRect (r:CGRect) :CIVector;

/* the CGAffineTransform's six values are stored in the first six values of the CIVector. */
	@:require(ios5) public static function vectorWithCGAffineTransform (t:CGAffineTransform) :CIVector;
...
/* Initializers. */
	...
	@:require(ios5) public function initWithCGPoint (p:CGPoint) :CIVector;
	@:require(ios5) public function initWithCGRect (r:CGRect) :CIVector;
	@:require(ios5) public function initWithCGAffineTransform (r:CGAffineTransform) :CIVector;
...
/* Getters. */
	...
	@:require(ios5) public function CGPointValue () :CGPoint;
	@:require(ios5) public function CGRectValue () :CGRect;
	@:require(ios5) public function CGAffineTransformValue () :CGAffineTransform;
