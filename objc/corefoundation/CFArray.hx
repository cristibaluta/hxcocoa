...
*/
	@:c public static function CFArrayGetTypeID() :CFTypeID;
...
/*!
	...
	*/
	@:c public static function CFArrayCreate (allocator:CFAllocatorRef, const void **values, numValues:CFIndex, callBacks:CFArrayCallBacks) :CFArrayRef;
...
/*!
	...
	@result A reference to the new immutable CFArray.
*/
	@:c public static function CFArrayCreateCopy(CFAllocatorRef allocator, CFArrayRef theArray) :CFArrayRef;
...
*/
	@:c public static function 
 CFArrayGetCountOfValue(CFArrayRef theArray, CFRange range, const void *value) :CFIndex;
...
*/
	@:c public static function 
Boolean CFArrayContainsValue(CFArrayRef theArray, CFRange range, const void *value) :Bool;
...
*/
	@:c public static function 
const void *CFArrayGetValueAtIndex(CFArrayRef theArray, CFIndex idx) :Void;
...
*/
	@:c public static function CFArrayInsertValueAtIndex(CFMutableArrayRef theArray, CFIndex idx, const void *value) :Void;
...
*/
	@:c public static function CFArraySetValueAtIndex(CFMutableArrayRef theArray, CFIndex idx, const void *value) :Void;
...
/*!
	...
	@param idx The index from which to remove the value. If the index is
		...
		behavior is undefined.
*/
	@:c public static function CFArrayRemoveValueAtIndex(CFMutableArrayRef theArray, CFIndex idx);
