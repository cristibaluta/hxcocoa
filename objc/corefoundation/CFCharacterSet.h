...
/*!
	...
	@result A reference to the new immutable CFCharacterSet.
*/
	@:c public static function  CFCharacterSetRef CFCharacterSetCreateInvertedSet(CFAllocatorRef alloc, CFCharacterSetRef theSet);
...
/*!
	...
	@param theOtherset  The character set to be checked whether or not it is a subset of theSet.
		If this parameter is not a valid CFCharacterSet, the behavior is undefined.
*/
	@:c public static function  Boolean CFCharacterSetIsSupersetOfSet(CFCharacterSetRef theSet, CFCharacterSetRef theOtherset);
...
*/
	@:c public static function  Boolean CFCharacterSetHasMemberInPlane(CFCharacterSetRef theSet, CFIndex thePlane);
...
/*!
	...
	@param theChar The UTF-32 character for which to test against the
        ...
        @result true, if the value is in the character set, otherwise false.
*/
	@:c public static function  Boolean CFCharacterSetIsLongCharacterMember(CFCharacterSetRef theSet, UTF32Char theChar);
