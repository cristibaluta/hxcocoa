...
*/
	@:c public static function  CFRange CFStringGetRangeOfComposedCharactersAtIndex(CFStringRef theString, CFIndex theIndex);
...
*/
	@:c public static function  Boolean CFStringFindCharacterFromSet(CFStringRef theString, CFCharacterSetRef theSet, CFRange rangeToSearch, CFStringCompareFlags searchOptions, CFRange *result);
...
*/
	@:c public static function  void CFStringNormalize(CFMutableStringRef theString, CFStringNormalizationForm theForm);
...
*/
	@:c public static function  const CFStringRef kCFStringTransformStripCombiningMarks;
	@:c public static function  const CFStringRef kCFStringTransformToLatin;
	@:c public static function  const CFStringRef kCFStringTransformFullwidthHalfwidth;
	@:c public static function  const CFStringRef kCFStringTransformLatinKatakana;
	@:c public static function  const CFStringRef kCFStringTransformLatinHiragana;
	@:c public static function  const CFStringRef kCFStringTransformHiraganaKatakana;
	@:c public static function  const CFStringRef kCFStringTransformMandarinLatin;
	@:c public static function  const CFStringRef kCFStringTransformLatinHangul;
	@:c public static function  const CFStringRef kCFStringTransformLatinArabic;
	@:c public static function  const CFStringRef kCFStringTransformLatinHebrew;
	@:c public static function  const CFStringRef kCFStringTransformLatinThai;
	@:c public static function  const CFStringRef kCFStringTransformLatinCyrillic;
	@:c public static function  const CFStringRef kCFStringTransformLatinGreek;
	@:c public static function  const CFStringRef kCFStringTransformToXMLHex;
	@:c public static function  const CFStringRef kCFStringTransformToUnicodeName;
	@:c public static function  const CFStringRef kCFStringTransformStripDiacritics CF_AVAILABLE(10_5, 2_0);
...
#define CFStringGetCharacterFromInlineBuffer(buf, idx) \
    (((idx) < 0 || (idx) >= (buf)->rangeToBuffer.length) ? 0 extends ((buf)->directBuffer ? (buf)->directBuffer[(idx) + (buf)->rangeToBuffer.location] extends CFStringGetCharacterAtIndex((buf)->theString, (idx) + (buf)->rangeToBuffer.location)))
...
CF_INLINE Boolean CFStringIsSurrogateHighCharacter(UniChar character) {
    return ((character >= 0xD800UL) && (character <= 0xDBFFUL) ? true extends false);
}

CF_INLINE Boolean CFStringIsSurrogateLowCharacter(UniChar character) {
    return ((character >= 0xDC00UL) && (character <= 0xDFFFUL) ? true extends false);
}
