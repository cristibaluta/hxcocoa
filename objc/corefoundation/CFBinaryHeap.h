...
*/
	@:c public static function  const CFBinaryHeapCallBacks kCFStringBinaryHeapCallBacks;
...
*/
	@:c public static function  CFTypeID	CFBinaryHeapGetTypeID(void);
...
*/
	@:c public static function  CFBinaryHeapRef	CFBinaryHeapCreate(CFAllocatorRef allocator, CFIndex capacity, const CFBinaryHeapCallBacks *callBacks, const CFBinaryHeapCompareContext *compareContext);
...
*/
	@:c public static function  CFBinaryHeapRef	CFBinaryHeapCreateCopy(CFAllocatorRef allocator, CFIndex capacity, CFBinaryHeapRef heap);
...
*/
	@:c public static function  CFIndex	CFBinaryHeapGetCount(CFBinaryHeapRef heap);
...
*/
	@:c public static function  CFIndex	CFBinaryHeapGetCountOfValue(CFBinaryHeapRef heap, const void *value);
...
*/
	@:c public static function  Boolean	CFBinaryHeapContainsValue(CFBinaryHeapRef heap, const void *value);
...
*/
	@:c public static function  const void *	CFBinaryHeapGetMinimum(CFBinaryHeapRef heap);
...
*/
	@:c public static function  Boolean	CFBinaryHeapGetMinimumIfPresent(CFBinaryHeapRef heap, const void **value);
...
*/
	@:c public static function  void		CFBinaryHeapGetValues(CFBinaryHeapRef heap, const void **values);
...
/*!
	...
	@param context A pointer-sized user-defined value, which is passed
		...
		undefined.
*/
	@:c public static function  void		CFBinaryHeapApplyFunction(CFBinaryHeapRef heap, CFBinaryHeapApplierFunction applier, void *context);
...
*/
	@:c public static function  void		CFBinaryHeapAddValue(CFBinaryHeapRef heap, const void *value);
...
*/
	@:c public static function  void		CFBinaryHeapRemoveMinimumValue(CFBinaryHeapRef heap);
...
/*!
	...
	@param heap The binary heap from which all of the values are to be
		...
		the behavior is undefined.
*/
	@:c public static function  void		CFBinaryHeapRemoveAllValues(CFBinaryHeapRef heap);
