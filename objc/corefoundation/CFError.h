...
// Predefined domains; value of "code" will correspond to preexisting values in these domains.
	@:c public static function  const CFStringRef kCFErrorDomainPOSIX		    CF_AVAILABLE(10_5, 2_0);
	@:c public static function  const CFStringRef kCFErrorDomainOSStatus	    CF_AVAILABLE(10_5, 2_0);
	@:c public static function  const CFStringRef kCFErrorDomainMach		    CF_AVAILABLE(10_5, 2_0);
	@:c public static function  const CFStringRef kCFErrorDomainCocoa		    CF_AVAILABLE(10_5, 2_0);
...
// Keys in userInfo for localizable, end-user presentable error messages. At minimum provide one of first two; ideally provide all three.
	@:c public static function  const CFStringRef kCFErrorLocalizedDescriptionKey         CF_AVAILABLE(10_5, 2_0);   // Key to identify the end user-presentable description in userInfo.
	@:c public static function  const CFStringRef kCFErrorLocalizedFailureReasonKey       CF_AVAILABLE(10_5, 2_0);   // Key to identify the end user-presentable failure reason in userInfo.
	@:c public static function  const CFStringRef kCFErrorLocalizedRecoverySuggestionKey  CF_AVAILABLE(10_5, 2_0);   // Key to identify the end user-presentable recovery suggestion in userInfo.

// If you do not have localizable error strings, you can provide a value for this key instead.
	@:c public static function  const CFStringRef kCFErrorDescriptionKey                  CF_AVAILABLE(10_5, 2_0);   // Key to identify the description in the userInfo dictionary. Should be a complete sentence if possible. Should not contain domain name or error code.

// Other keys in userInfo.
	@:c public static function  const CFStringRef kCFErrorUnderlyingErrorKey              CF_AVAILABLE(10_5, 2_0);   // Key to identify the underlying error in userInfo.
	@:c public static function  const CFStringRef kCFErrorURLKey                          CF_AVAILABLE(10_7, 5_0);    // Key to identify associated URL in userInfo.  Typically one of this or kCFErrorFilePathKey is provided.
	@:c public static function  const CFStringRef kCFErrorFilePathKey                     CF_AVAILABLE(10_7, 5_0);    // Key to identify associated file path in userInfo.    Typically one of this or kCFErrorURLKey is provided.
