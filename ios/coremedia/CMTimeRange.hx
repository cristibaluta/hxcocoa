...
*/
typedef CMTimeRange = {
	var start :CMTime;		/*! @field start The start time of the time range. */
	var duration :CMTime;	/*! @field duration The duration of the time range. */
};
...
*/
@:c public static function CMTIMERANGE_IS_VALID(range:CMTimeRange) :Bool;
...
*/
@:c public static function CMTIMERANGE_IS_INVALID(range:CMTimeRange) :Bool;
