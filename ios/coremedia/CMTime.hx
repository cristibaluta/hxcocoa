...
typedef CMTimeValue = Int;//int64_t
...
*/
typedef CMTimeScale = Int;

/*!
	@typedef	CMTimeEpoch
	@abstract	Epoch (eg, loop number) to which a CMTime refers.
*/
typedef CMTimeEpoch = Int;//int64_t
...
*/
typedef CMTime {
	var	value :CMTimeValue;		/*! @field value The value of the CMTime. value/timescale = seconds. */
	var	timescale :CMTimeScale;	/*! @field timescale The timescale of the CMTime. value/timescale = seconds.  */
	var	flags :CMTimeFlags;		/*! @field flags The flags, eg. kCMTimeFlags_Valid, kCMTimeFlags_PositiveInfinity, etc. */
	var	epoch :CMTimeEpoch;		/*! @field epoch Differentiates between equal timestamps that are actually different because
