...
// in accordance with the OpenGLES 1.1 specification.
//
// Per the OpenGLES1.1 specification, light position and directions are transformed
...
//
// Note that, as with OpenGLES 1.1 differentiation between a directional and spot light
