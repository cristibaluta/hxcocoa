...
//
// GLKReflectionMapEffect requires an OpenGL 2.0 or greater context be initialized and made current
// prior to creating or initializing GLKReflectionMapEffect instances.  No OpenGLES context state
// settings are modified when a GLKReflectionMapEffect instance is created or its properties set.  When
...
//
//      (1) Alloc/init an instance of GLKReflectionMapEffect
//      
