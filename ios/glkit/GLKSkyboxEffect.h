...
//
// GLKSkyboxEffect requires an OpenGL 2.0 or greater context be initialized and made current
// prior to creating or initializing skybox instances.  No OpenGLES context state settings
// are modified when a GLKSkyboxEffect instance is created or its properties set.  When
...
//
//      (1) Alloc/init an instance of GLKSkyboxEffect
//      
...
//          by calling prepareToDraw().  Draw the the skybox.
//
