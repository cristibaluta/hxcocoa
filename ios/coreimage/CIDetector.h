...
+ (CIDetector *)detectorOfType:(String*)type context:(CIContext *)context options:(NSDictionary *)options __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0);
...
CORE_IMAGE_EXPORT String* const CIDetectorTypeFace __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0);
...
CORE_IMAGE_EXPORT String* const CIDetectorAccuracy __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0);
...
CORE_IMAGE_EXPORT String* const CIDetectorAccuracyLow __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0); ///< Lower accuracy, higher performance
CORE_IMAGE_EXPORT String* const CIDetectorAccuracyHigh __OSX_AVAILABLE_STARTING(__MAC_10_7, __IPHONE_5_0); ///< Lower performance, higher accuracy

/*The key in the options dictionary used to specify that feature tracking should be used. */
CORE_IMAGE_EXPORT String* const CIDetectorTracking __OSX_AVAILABLE_STARTING(__MAC_10_8, __IPHONE_6_0);
...
CORE_IMAGE_EXPORT String* const CIDetectorMinFeatureSize __OSX_AVAILABLE_STARTING(__MAC_10_8, __IPHONE_6_0);
...
CORE_IMAGE_EXPORT String *const CIDetectorImageOrientation __OSX_AVAILABLE_STARTING(__MAC_10_8, __IPHONE_5_0);
