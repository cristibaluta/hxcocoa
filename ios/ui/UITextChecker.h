...
- (NSRange)rangeOfMisspelledWordInString:(NSString *)stringToCheck range:(NSRange)range startingAt:(Int)startingOffset wrap:(BOOL)wrapFlag language:(NSString *)language;
