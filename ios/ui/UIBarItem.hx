...
extern class UIBarItem extends NSObject implements UIAppearance {
	...
	@:require(ios5)public var landscapeImagePhone :UIImage;
	public var imageInsets :UIEdgeInsets;  // default is UIEdgeInsetsZero
	@:require(ios5)public var landscapeImagePhoneInsets :UIEdgeInsets;
	public var tag :Int;          // default is 0
	
	@:require(ios5)public function setTitleTextAttributes (attributes:NSDictionary, forState:UIControlState) :Void;
	@:require(ios5)public function titleTextAttributesForState (state:UIControlState) :NSDictionary;
