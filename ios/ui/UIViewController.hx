...
extern class UIViewController extends UIResponder {
	...
	@:require(ios5)public var storyboard (default, null) :UIStoryboard;

	@:require(ios5)public function performSegueWithIdentifier (identifier:String, sender:Dynamic) :Void;
	@:require(ios6)public function shouldPerformSegueWithIdentifier (identifier:String, sender:Dynamic) :Bool;
	@:require(ios5)public function prepareForSegue (segue:UIStoryboardSegue, sender:Dynamic) :Void;

// View controllers will receive this message during segue unwinding. The default implementation returns the result of -respondsToSelector: - controllers can override this to perform any ancillary checks, if necessary.
	@:require(ios6)public function canPerformUnwindSegueAction (action:SEL, fromViewController:UIViewController, withSender:Dynamic) :Bool;
...
// Custom containers should override this method and search their children for an action handler (using -canPerformUnwindSegueAction:fromViewController:sender:). If a handler is found, the controller should return it. Otherwise, the result of invoking super's implementation should be returned.
	@:require(ios6)public function viewControllerForUnwindSegueAction (action:SEL, fromViewController:UIViewController, withSender:Dynamic) :UIViewController;
...
// Custom container view controllers should override this method and return segue instances that will perform the navigation portion of segue unwinding.
	@:require(ios6)public function segueForUnwindingToViewController (toViewController:UIViewController, fromViewController:UIViewController, identifier:String) :UIStoryboardSegue;
...
// Called just before the view controller's view's layoutSubviews method is invoked. Subclasses can implement as necessary. The default is a nop.
	@:require(ios5)public function viewWillLayoutSubviews () :Void;
// Called just after the view controller's view's layoutSubviews method is invoked. Subclasses can implement as necessary. The default is a nop.
	@:require(ios5)public function viewDidLayoutSubviews () :Void;
...
// The view controller that was presented by this view controller or its nearest ancestor.
	@:require(ios5)public var presentedViewController (default, null) :UIViewController;

// The view controller that presented this view controller (or its farthest ancestor.)
	@:require(ios5)public var presentingViewController (default, null) :UIViewController;

	@:require(ios5)public var definesPresentationContext :Bool;

// A controller that defines the presentation context can also specify the modal transition style if this property is true.
	@:require(ios5)public var providesPresentationContextTransitionStyle :Bool;


	@:require(ios5)public function isBeingPresented () :Bool;
	@:require(ios5)public function isBeingDismissed () :Bool;

	@:require(ios5)public function isMovingToParentViewController () :Bool;
	@:require(ios5)public function isMovingFromParentViewController () :Bool;


	@:require(ios5)public function presentViewController (viewControllerToPresent:UIViewController, animated:Bool, completion:Void->Void) :Void;
// The completion handler, if provided, will be invoked after the dismissed controller's viewDidDisappear: callback is invoked.
	@:require(ios5)public function dismissViewControllerAnimated (flag:Bool, completion:Void->Void) :Void;
...
// if the current interface orientation does not match the current device orientation, a rotation may occur provided all relevant view controllers now return YES from shouldAutorotateToInterfaceOrientation:
	@:require(ios5)public static function attemptRotationToDeviceOrientation () :Void;

// New Autorotation support.
	@:require(ios6)public function shouldAutorotate () :Bool;
	@:require(ios6)public function supportedInterfaceOrientations () :Int;
// Returns interface orientation masks.
	@:require(ios6)public function preferredInterfaceOrientationForPresentation () :UIInterfaceOrientation;
...
// An array of children view controllers. This array does not include any presented view controllers.
	@:require(ios5)public var childViewControllers (default, null) :Array<UIViewController>;
	@:require(ios5)public function addChildViewController (childController:UIViewController) :Void;
	@:require(ios5)public function removeFromParentViewController () :Void;
	@:require(ios5)public function transitionFromViewController (fromViewController:UIViewController, toViewController:UIViewController, duration:Float, options:UIViewAnimationOptions, animations:Void->Void, completion:Bool->Void) :Void;
...
// now tied to the final matching invocation of endAppearanceTransition.
	@:require(ios5)public function beginAppearanceTransition (isAppearing:Bool, animated:Bool) :Void;
	@:require(ios5)public function endAppearanceTransition () :Void;

// (UIContainerViewControllerCallbacks)


	@:require(ios6)public function shouldAutomaticallyForwardRotationMethods () :Bool;
	@:require(ios6)public function shouldAutomaticallyForwardAppearanceMethods () :Bool;



	@:require(ios5)public function willMoveToParentViewController (parent:UIViewController) :Void;
	@:require(ios5)public function didMoveToParentViewController (parent:UIViewController) :Void;


// (UIStateRestoration)
	@:require(ios6)public var restorationIdentifier :String;
	//@:require(ios6)public var restorationClass :Class<UIViewControllerRestoration>;
	@:require(ios6)public function encodeRestorableStateWithCoder (coder:NSCoder) :Void;
	@:require(ios6)public function decodeRestorableStateWithCoder (coder:NSCoder) :Void;

//UIConstraintBasedLayoutCoreMethods)

	@:require(ios6)public function updateViewConstraints () :Void;
