...
extern class UIColor extends NSObject {
	...
	//@:require(ios5) public static function colorWithCIColor (ciColor:CIColor) :UIColor;
	...
	//@:require(ios5) public function initWithCIColor (ciColor:CIColor) :UIColor;
	...
	@:require(ios5) public function getWhite (white:Float, alpha:Float) :Bool;
	@:require(ios5) public function getHue (hue:Float, saturation:Float, brightness:Float, alpha:Float) :Bool; 
	@:require(ios5) public function getRed (red:Float, green:Float, blue:Float, alpha:Float) :Bool;
	...
	@:require(ios5) public function initWithColor (color:UIColor) :UIColor;
