...
// Content.  These properties provide direct access to the internal label and image views used by the table view cell.  These should be used instead of the content properties below.
	...
	public var textLabel (default, null) :UILabel;   // default is nil.  label will be created if necessary.
	public var detailTextLabel (default, null) :UILabel; // default is nil.  label will be created if necessary (and the current style supports a detail label).
